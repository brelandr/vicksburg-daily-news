					...
					<div class="mvp-feat1-list-wrap left relative">
						<div class="mvp-feat1-list-head-wrap left relative">
							<ul class="mvp-feat1-list-buts left relative">
								...
								<?php $feat_video_check = new WP_Query(array( 'tax_query' => array( array( 'taxonomy' => 'post_format', 'field' => 'slug', 'terms' => 'post-format-video' )), 'posts_per_page' => 1 )); if ($feat_video_check->have_posts()) : ?>
									<li><a href="#mvp-feat-tab-col2"><span class="mvp-feat1-list-but"><?php esc_html_e( 'Videos', 'zox-news' ); ?></span></a></li>
								<?php endif; wp_reset_postdata(); ?>
								<?php $feat_gallery_check = new WP_Query(array( 'tax_query' => array( array( 'taxonomy' => 'post_format', 'field' => 'slug', 'terms' => 'post-format-gallery' )), 'posts_per_page' => 1 )); if ($feat_gallery_check->have_posts()) : ?>
						...
						<div id="mvp-feat-tab-col1" class="mvp-feat1-list left relative mvp-tab-col-cont">
							<?php global $do_not_duplicate; if (isset($do_not_duplicate)) { if(get_option('mvp_feat_ad')) { $mvp_feat_list_num = 10; } else { $mvp_feat_list_num = 13; }; $paged = (get_query_var('page')) ? get_query_var('page') : 1; $feat_latest_query = new WP_Query(array( 'posts_per_page' => $mvp_feat_list_num, 'post__not_in'=>$do_not_duplicate, 'paged' =>$paged, 'ignore_sticky_posts'=> 1 )); if ($feat_latest_query->have_posts()) : while ($feat_latest_query->have_posts()) : $feat_latest_query->the_post(); ?>
								<a href="<?php the_permalink(); ?>" rel="bookmark">
						...
						<div id="mvp-feat-tab-col2" class="mvp-feat1-list left relative mvp-tab-col-cont">
							<?php global $do_not_duplicate; if (isset($do_not_duplicate)) { if(get_option('mvp_feat_ad')) { $mvp_feat_list_num = 10; } else { $mvp_feat_list_num = 13; }; $paged = (get_query_var('page')) ? get_query_var('page') : 1; $feat_video_query = new WP_Query(array( 'tax_query' => array( array( 'taxonomy' => 'post_format', 'field' => 'slug', 'terms' => 'post-format-video' )), 'posts_per_page' => $mvp_feat_list_num, 'ignore_sticky_posts'=> 1, 'post__not_in'=>$do_not_duplicate, 'paged' =>$paged )); if ($feat_video_query->have_posts()) : while ($feat_video_query->have_posts()) : $feat_video_query->the_post(); ?>
								<a href="<?php the_permalink(); ?>" rel="bookmark">
								<div class="mvp-feat1-list-cont left relative">
									<?php if (  (function_exists('has_post_thumbnail')) && (has_post_thumbnail())  ) { ?>
										<div class="mvp-feat1-list-out relative">
						...
						<div id="mvp-feat-tab-col3" class="mvp-feat1-list left relative mvp-tab-col-cont">
							<?php global $do_not_duplicate; if (isset($do_not_duplicate)) { if(get_option('mvp_feat_ad')) { $mvp_feat_list_num = 10; } else { $mvp_feat_list_num = 13; }; $paged = (get_query_var('page')) ? get_query_var('page') : 1; $feat_gallery_query = new WP_Query(array( 'tax_query' => array( array( 'taxonomy' => 'post_format', 'field' => 'slug', 'terms' => 'post-format-gallery' )), 'posts_per_page' => $mvp_feat_list_num, 'ignore_sticky_posts'=> 1, 'post__not_in'=>$do_not_duplicate, 'paged' =>$paged )); if ($feat_gallery_query->have_posts()) : while ($feat_gallery_query->have_posts()) : $feat_gallery_query->the_post(); ?>
								<a href="<?php the_permalink(); ?>" rel="bookmark">
								<div class="mvp-feat1-list-cont left relative">
									<?php if (  (function_exists('has_post_thumbnail')) && (has_post_thumbnail())  ) { ?>
										<div class="mvp-feat1-list-out relative">
				...
				<div class="mvp-feat5-side-in">
					<div class="mvp-feat5-main-wrap left relative">
						...
						<div class="mvp-feat5-small-wrap left relative">
							...
							<?php global $do_not_duplicate; if (isset($do_not_duplicate)) { $paged = (get_query_var('page')) ? get_query_var('page') : 1; $feat5_latest_query = new WP_Query(array( 'posts_per_page' => '1', 'post__not_in'=>$do_not_duplicate, 'paged' =>$paged, 'ignore_sticky_posts'=> 1 )); if ($feat5_latest_query->have_posts()) : while ($feat5_latest_query->have_posts()) : $feat5_latest_query->the_post(); $do_not_duplicate[] = $post->ID; ?>
								<a href="<?php the_permalink(); ?>" rel="bookmark">
							...
							<div class="mvp-feat5-small-sub left relative">
								<?php global $do_not_duplicate; if (isset($do_not_duplicate)) { $paged = (get_query_var('page')) ? get_query_var('page') : 1; $feat5_more_query = new WP_Query(array( 'posts_per_page' => '6', 'post__not_in'=>$do_not_duplicate, 'paged' =>$paged, 'ignore_sticky_posts'=> 1 )); if ($feat5_more_query->have_posts()) : while ($feat5_more_query->have_posts()) : $feat5_more_query->the_post(); ?>
									<a href="<?php the_permalink(); ?>" rel="bookmark">
									<div class="mvp-feat1-list-cont left relative">
										<?php if (  (function_exists('has_post_thumbnail')) && (has_post_thumbnail())  ) { ?>
											<div class="mvp-feat1-list-out relative">
