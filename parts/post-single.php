							...
							<div class="mvp-vid-wide-out left relative">
											...
											<div id="mvp-video-embed-wrap" class="left relative">
												<div id="mvp-video-embed-cont" class="left relative">
													...
													<div id="mvp-video-embed" class="left relative">
														<?php echo html_entity_decode( (string) get_post_meta($post->ID, "mvp_video_embed", true), ENT_QUOTES | ENT_HTML5, 'UTF-8' ); ?>
													</div><!--mvp-video-embed-->
								...
								<div class="mvp-vid-wide-right left relative">
									<div class="mvp-vid-wide-text left relative">
										...
										<h1 class="mvp-post-title mvp-vid-wide-title left entry-title"><?php the_title(); ?></h1>
										<?php if ( has_excerpt() ) { ?>
						...
						<div class="mvp-vid-wide-bot left relative">
							...
							<div class="mvp-vid-wide-more-wrap left relative">
								<ul class="mvp-vid-wide-more-list left relative">
									<?php global $post; $related_videos = new WP_Query(array( 'tax_query' => array( array( 'taxonomy' => 'post_format', 'field' => 'slug', 'terms' => 'post-format-video' )), 'posts_per_page' => '4', 'post__not_in' => array($post->ID) )); if ($related_videos->have_posts()) : while ($related_videos->have_posts()) : $related_videos->the_post(); ?>
							...
							<div id="mvp-post-feat-text-wrap" class="left relative">
								<div class="mvp-post-feat-text-main">
									<div class="mvp-post-feat-text left relative">
										...
										<h1 class="mvp-post-title mvp-post-title-wide left entry-title"><?php the_title(); ?></h1>
										<?php if ( has_excerpt() ) { ?>
											<span class="mvp-post-excerpt left"><?php the_excerpt(); ?></span>
										<?php } ?>
		...
		<div id="mvp-article-cont" class="left relative">
			<div class="mvp-main-box">
				<div id="mvp-post-main" class="left relative">
					...
					<?php if ( function_exists( 'the_ad_group' ) ) { the_ad_group(597); } ?>
																		...
																		<div id="mvp-author-box-head" class="left relative">
																			...
																			<div id="mvp-author-box-soc-wrap" class="left relative">
																				...
																				<?php $authordesc = get_the_author_meta( 'twitter' ); if ( ! empty ( $authordesc ) ) { ?>
																					<a href="<?php echo esc_url( get_the_author_meta( 'twitter' ) ); ?>" alt="Twitter" target="_blank"><span class="mvp-author-box-soc fa fa-twitter-square fa-2"></span></a>
																				<?php } ?>
														...
														<div class="mvp-org-wrap">
															<div class="mvp-org-logo">
																<?php if(get_option('mvp_logo')) { ?>
																	<img src="<?php echo zox_news_esc_url_option('mvp_logo'); ?>"/>
																<?php } else { ?>
												...
												<div class="mvp-cont-read-wrap">
													...
													<?php $mvp_related = get_option('mvp_related_posts'); if ($mvp_related == "true") { ?>
														<div id="mvp-related-posts" class="left relative">
															...
															<?php if ( function_exists( 'mvp_RelatedPosts' ) ) { mvp_RelatedPosts(); } ?>
